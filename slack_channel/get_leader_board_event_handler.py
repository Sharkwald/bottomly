...
class GetLeaderBoardEventHandler(AbstractEventHandler):
    @property
    def command(self) -> GetLeaderBoardCommand:
        return GetLeaderBoardCommand()
    ...
    def get_usage(self):
        return self.command_trigger + "[size of leaderboard. Default is 3]"
