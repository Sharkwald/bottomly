...
public class ReleaseHandlerTests
{
    ...
    public ReleaseHandlerTests()
    {
        ...
        _handler = new ReleaseHandler(_mockCommand.Object, _mockBroker.Object, options,
            NullLogger<ReleaseHandler>.Instance);
    }
