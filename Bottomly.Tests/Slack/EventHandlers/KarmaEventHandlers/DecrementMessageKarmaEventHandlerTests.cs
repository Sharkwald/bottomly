...
public class DecrementMessageKarmaEventHandlerTests
{
    private readonly DecrementMessageKarmaEventHandler _handler;
    ...
    public DecrementMessageKarmaEventHandlerTests()
    {
        ...
        _handler = new DecrementMessageKarmaEventHandler(command, parser, _mockMemberRepo.Object, _mockBroker.Object,
            options,
            NullLogger<DecrementMessageKarmaEventHandler>.Instance);
    }
