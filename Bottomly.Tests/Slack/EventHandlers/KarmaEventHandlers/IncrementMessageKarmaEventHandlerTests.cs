...
public class IncrementMessageKarmaEventHandlerTests
{
    ...
    public IncrementMessageKarmaEventHandlerTests()
    {
    ...
    public async Task HandleAsync_HelpEvent_SendsHelpMessage()
    {
        ...
        _mockBroker.Verify(b => b.SendMessageAsync(It.Is<string>(s => s.Contains("Pozzy-poz")), "C1", null),
            Times.Once());
    }
}