...
public class GetCurrentNetKarmaEventHandlerTests
{
    private readonly GetCurrentNetKarmaEventHandler _handler;
    ...
    public GetCurrentNetKarmaEventHandlerTests()
    {
        ...
        _handler = new GetCurrentNetKarmaEventHandler(command, parser, _mockBroker.Object, options,
            NullLogger<GetCurrentNetKarmaEventHandler>.Instance);
    }
