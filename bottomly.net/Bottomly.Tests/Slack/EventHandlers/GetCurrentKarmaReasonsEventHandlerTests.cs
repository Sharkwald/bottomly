...
public class GetCurrentKarmaReasonsEventHandlerTests
{
    private readonly GetCurrentKarmaReasonsEventHandler _handler;
    ...
    public GetCurrentKarmaReasonsEventHandlerTests()
    {
        ...
        _handler = new GetCurrentKarmaReasonsEventHandler(command, parser, _mockBroker.Object, options,
            NullLogger<GetCurrentKarmaReasonsEventHandler>.Instance);
    }
